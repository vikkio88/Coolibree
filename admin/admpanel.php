...
<script src="../js/adminutils.js" type="text/javascript"></script>
<body onload="load()">
...
EOP;
	...
	$page.="You are logged as:<strong> <span id=\"user\">".$username."</span></strong> <span style=\"font-size:0.8em\"><a href=\"#\" onclick=\"logout()\">logout[X]</a></span>";
