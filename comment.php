...
if($checkingvar){
		...
		echo 'setTimeout("location.href=\'./view.php?id='.$id_post.'#comment\', 3*1000 ");</script>';
}else{
		echo '<script>alert("Something go wrong! =(,retry? error code:'.$error.'");';
		echo 'setTimeout("history.back()", 1000 );</script>';
}
